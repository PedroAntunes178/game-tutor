...
export default function ChatInterface({ game, isOpen, onClose, isInline = false }: ChatInterfaceProps) {
  ...
  const initializeChat = useCallback(async () => {
    if (isInitialized || isLoading) return; // Prevent duplicate calls
    
    setIsLoading(true);
    const initialMessage: ChatMessage = {
      id: Date.now().toString(),
      role: 'user',
      content: `I want to learn how to play ${game.name}. Can you help me?`,
      timestamp: new Date()
    };
